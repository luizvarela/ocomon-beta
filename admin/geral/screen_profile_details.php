<?php 
  ...
  */session_start();
	...
	if (isset($_GET['cod_profile'])){
		$COD = $_GET['cod_profile'];
	}	
...
//         	"</TD><br><BR>";
        ...
        else
        {
			...
			print "<tr><td>".TRANS('OPT_FIELD_AREA')."</td><td>".transbool($row['conf_scr_area'])."</td></tr>";
			print "<tr><td>".TRANS('OPT_FIELD_PROB')."</td><td>".transbool($row['conf_scr_prob'])."</td></tr>";
			print "<tr><td>".TRANS('OPT_FIELD_DESC')."</td><td>".transbool($row['conf_scr_desc'])."</td></tr>";
			print "<tr><td>".TRANS('OPT_FIELD_UNIT')."</td><td>".transbool($row['conf_scr_unit'])."</td></tr>";
			print "<tr><td>".TRANS('OPT_FIELD_TAG')."</td><td>".transbool($row['conf_scr_tag'])."</td></tr>";
	...
	if ((isset($_GET['action']) && ($_GET['action']=="alter")) && empty($_POST['submit'])){
		...
		if ($row['conf_user_opencall'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_user_opencall'] == 1) print " selected='selected'";
		...
		while ($rowtoarea = mysql_fetch_array($exectoarea)){
			...
			if ($rowtoarea['sis_id'] == $row['sis_id']) print " selected='selected'";
		...
		print "<option value='0'";
		if ($row['conf_scr_area'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_area'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_prob'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_prob'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_desc'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_desc'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_unit'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_unit'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_tag'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_tag'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_chktag'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_chktag'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_chkhist'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_chkhist'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_contact'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_contact'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_fone'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_fone'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_local'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_local'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_btloadlocal'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_btloadlocal'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_searchbylocal'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_searchbylocal'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_operator'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_operator'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_date'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_date'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_schedule'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_schedule'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_foward'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_foward'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_status'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_status'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_replicate'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_replicate'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_upload'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_upload'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_prior'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_prior'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		print "<option value='0'";
		if ($row['conf_scr_mail'] == 0) print " selected='selected'";
		print ">".TRANS('NOT')."</option>";
		print "<option value='1'";
		if ($row['conf_scr_mail'] == 1) print " selected='selected'";
		print ">".TRANS('YES')."</option>";
		print "</select></td></tr>";
		...
		if (isset($COD))
			print "<input type='hidden' name='COD' value='".$COD."'";
	...
	if ($_POST['submit'] = TRANS('BT_ALTER')){
		...
		$qry = "UPDATE configusercall SET ".
				"conf_name= '".noHtml($_POST['screen_name'])."', ".
				"conf_user_opencall= ".$_POST['useropencall'].", ".
				"conf_opentoarea = ".$_POST['toarea'].", ".
...
// 		}
		...
		print "<script>mensagem('".TRANS('MSG_SUCCES_ALTER','',0)."'); redirect('screenprofiles.php');</script>";
	}
?>
