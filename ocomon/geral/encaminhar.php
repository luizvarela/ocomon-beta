<?php 
  ...
  */session_start();
	...
	print "<html>";
	print "<body onLoad=\"ajaxFunction('divSelProblema', 'showSelProbs.php', 'idLoad', 'prob=idProblema', 'area_cod=idArea', 'area_habilitada=idAreaHabilitada'); 
	                      ajaxFunction('divProblema',    'showProbs.php'   , 'idLoad', 'prob=idProblema', 'area_cod=idArea'); checarSchedule(''); 
		...
		print "</TR>";
        	...
        	print "<TR>";
				...
				print "<SELECT class='select' name='sistema' id='idArea' 
				    onChange=\"ajaxFunction('divSelProblema', 'showSelProbs.php', 'idLoad', 'prob=idProblema', 'area_cod=idArea', 'area_habilitada=idAreaHabilitada'); 
					           ajaxFunction('divProblema'   , 'showProbs.php'   , 'idLoad', 'prob=idProblema', 'area_cod=idArea'); \">"; //ajaxFunction('divInformacaoProblema', 'showInformacaoProb.php', 'idLoad', 'prob=idProblema', 'area_cod=idArea');
...
##################################################################################################
			...
			print "<TR>";
				...
				<script type="text/javascript">
					...
					if (bar == 1) {
						var oFCKeditor = new FCKeditor( 'idDescricao' ) ;
		...
		print "<TR>";
                	print "<TD width='20%' align='left' bgcolor='".TD_COLOR."' valign='top'>".TRANS('FIELD_NESTING').":<br /><br />".
                		"".TRANS('CHECK_ASSET_PRIVATED')."<input type='checkbox' name='check_asset_privated' value='1' checked></TD>";
                	print "<TD colspan='5' width='80%' align='left' bgcolor='".BODY_COLOR."'>";
			if (!$_SESSION['s_formatBarOco']) {
